...
const bloqueoEnElDragon = new Muro(xTP = 17, yTP = 1, posX = 16, posY = 1)
const bloqueoBordeCannon03 = new Muro(xTP = 11, yTP = 7, posX = 10, posY = 7)
const bloqueoBordeCannon02 = new Muro(xTP = 11, yTP = 4, posX = 10, posY = 4)
